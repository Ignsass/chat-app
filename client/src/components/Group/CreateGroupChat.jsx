...
function GroupChatCreate({ setModalActive }) {
    ...
    useEffect(() => {
        function handleClickOutside(event) {
            if (modalRef.current && !modalRef.current.contains(event.target)) {
                setModalActive("not"); // Close modal if click is outside
            }
        }
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            setModalActive("not"); // Close modal after creating chat
        } catch (error) {
    ...
    return (
        <>
            <div className="create-group modal-wrapper">
                <div className={`modal-container ${activeSearch ? 'active-search' : ''}`} ref={modalRef}>
